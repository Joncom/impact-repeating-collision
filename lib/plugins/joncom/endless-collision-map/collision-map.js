        ...
        */
        ...
        _traceStep: function( res, x, y, vx, vy, width, height, rvx, rvy, step ) {
            ...
            if( vx ) {
                ...
                var newTileX;
                if(tileX >= this.width) {
                    newTileX = tileX % this.width;
                } else if(tileX < 0) {
                    newTileX = this.width - Math.abs(tileX % this.width);
                }
                var tileXSkipped = tileX - newTileX;
                tileX = newTileX;
                ...
                if( tileX >= 0 && tileX < this.width ) {
                    for( var tileY = firstTileY; tileY < lastTileY; tileY++ ) {
                        ...
                        if(
                            ...
                            // New
                            x = res.pos.x = (tileX + tileXSkipped) * this.tilesize - pxOffsetX + tileOffsetX;
