        ...
        */
        ...
        _traceStep: function( res, x, y, vx, vy, width, height, rvx, rvy, step ) {
            ...
            if( vx ) {
                ...
                var tileXWrapped = tileX;
                if(tileX >= this.width) {
                    tileXWrapped = tileX % this.width;
                } else if(tileX < 0) {
                    tileXWrapped = this.width - Math.abs(tileX % this.width);
                }
                var prevTileXWrapped;
                if(prevTileX !== null) {
                    prevTileXWrapped = this.width - Math.abs(prevTileX % this.width);
                }
